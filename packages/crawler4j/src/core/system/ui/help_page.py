...
class HelpPage(QWidget):
    ...
    DOC_ENTRIES = [
        ...
        HelpDocEntry("developer-index", "developer-guide", "开发指南概览", "03-developer-guide/v0.4.0/index.md"),
        HelpDocEntry("developer-quickstart", "developer-guide", "快速开始", "03-developer-guide/v0.4.0/quickstart.md"),
        HelpDocEntry("developer-core-concepts", "developer-guide", "核心概念", "03-developer-guide/v0.4.0/core-concepts.md"),
        HelpDocEntry("developer-module-structure", "developer-guide", "模块结构", "03-developer-guide/v0.4.0/module-structure.md"),
        HelpDocEntry("reference-core-capabilities", "developer-guide", "Core 能力参考", "03-developer-guide/v0.4.0/reference-core-capabilities.md"),
        HelpDocEntry(
            "developer-sdk-cli-reference",
            "developer-guide",
            "SDK / CLI 参考",
            "03-developer-guide/v0.4.0/reference-sdk-and-cli.md",
        ),
        HelpDocEntry(
            "developer-ui-and-data-table",
            "developer-guide",
            "UI / Data Table",
            "03-developer-guide/v0.4.0/ui-and-data-table.md",
        ),
        HelpDocEntry("developer-debugging", "developer-guide", "调试", "03-developer-guide/v0.4.0/debugging.md"),
        HelpDocEntry("build-modules", "developer-guide", "构建", "03-developer-guide/v0.4.0/build-modules.md"),
        HelpDocEntry("developer-shipping", "developer-guide", "发布", "03-developer-guide/v0.4.0/shipping.md"),
        HelpDocEntry(
            "developer-troubleshooting",
            "developer-guide",
            "故障排查",
            "03-developer-guide/v0.4.0/troubleshooting.md",
        )
    ]
    DOC_GROUPS = [
        ("user-guide", "使用指南"),
