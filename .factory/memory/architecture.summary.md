...
- `packages/crawler4j/src/core/mms/ui/module_ui_runtime.py` reads pages from `PageSpec`; Hosted UI page source remains separate from v2 object graph declarations.
