...
- Keep task lifecycle control behind workflow `TaskResult` return values and object `cleanup(ctx, outcome)`; do not reintroduce module lifecycle hooks, root shims, `TaskSignal`, or run-profile teardown rules
