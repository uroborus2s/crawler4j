...
- Current app package version: `0.4.15`
- Runtime package version: `0.4.15`
- SDK version: `0.4.2`
- Contracts version: `0.4.2`

Evidence status:

- Root build: latest recorded artifact passed on 2026-05-26 for `crawler4j 0.4.3`; current `crawler4j 0.4.15` package build is not yet refreshed
...
- Local code quality gate: PASS for the 0.4.15 VirtualBrowser source proxy parsing repair scope
