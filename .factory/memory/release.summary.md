...
- Current app package version: `0.4.30`
- Runtime package version: `0.4.30`
- SDK published version: `0.4.4`
- Contracts published version: `0.4.3`

Evidence status:

- Root build: `crawler4j 0.4.30` wheel/sdist built on 2026-07-10; wheel METADATA and embedded package README both report `0.4.30`
...
- Full test/lint gate: 2026-07-10 client 0.4.30 full unit `1135 passed`; full Ruff, `uv lock --check`, `.factory/project.json` JSON validation, docs-stratego and `git diff --check` passed
- UI / CLI smoke: client UI smoke passed on 2026-07-10; historical SDK CLI help remains passed
...
- Client source version gate: PASS for crawler4j 0.4.30; desktop installer build/upload not included
