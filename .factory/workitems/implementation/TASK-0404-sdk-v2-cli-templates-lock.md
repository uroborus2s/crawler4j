...
- 新增/收口 interface、component、page action、data table、data query 与 manifest lock 命令。
...
- 默认脚手架生成示例 `@interface`、`@component`、`@workflow`、`@page_action`、`@data_table`、`@data_query`，并立即写入 `.crawler4j/manifest.lock.json`。
