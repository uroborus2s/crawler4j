...
**上游输入：** `docs/02-requirements/` | `docs/03-solution/` | `task-breakdown.md`  
**下游输出：** `.factory/workitems/` | `docs/05-quality/test-plan.md` | `docs/06-release/release-notes.md`  
...
| Wave 9 | `TASK-012` | `TASK-011`、`CR-003` 剩余范围 | UI trust gate 与自定义页面加载 | 当前下一波次 |
...
- 当前活动波次：`TASK-012`
- 当前首项：补齐 UI trust gate 与自定义页面真实加载
