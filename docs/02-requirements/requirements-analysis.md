...
**下游输出：** `requirements-verification.md` | `docs/03-solution/` | `docs/04-delivery/`  
**关联 ID：** `REQ-001`, `REQ-002`, `REQ-003`, `REQ-004`, `REQ-005`, `BUG-001`, `CR-001`, `CR-002`  
**最后更新：** 2026-03-26  
...
| 优先级 | 项目 | 原因 |
|---|---|---|
| P1 | `CR-003` MMS settings / UI 扩展高阶能力收口 | 影响模块治理、持久化配置与 UI Host 合规闭环 |
