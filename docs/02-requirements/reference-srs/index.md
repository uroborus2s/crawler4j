...
> 本目录现在定位为“旧专题详细参考层”。
> 当前正式人类文档入口请先阅读：
> [当前真实状态](../01-discovery/current-state-analysis.md)、
> [系统架构](../03-solution/system-architecture.md)、
> [文档索引](../traceability/document-index.md)。

本目录为 Crawler4j《系统需求与功能规格说明书》（SRS/FSD）的**多文件拆分版**，用于按专题拆分维护，并作为当前编号文档体系的详细参考层。
