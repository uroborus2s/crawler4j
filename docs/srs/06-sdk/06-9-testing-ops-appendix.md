...
- 统一错误码规则见 6.7；全局错误码索引见：`docs/srs/appendix/B-error-codes.md`

### 6.9.3.3 配置项索引

- 全局配置项索引见：`docs/srs/appendix/C-config-index.md`

### 6.9.3.4 追溯

- 需求追溯矩阵见：`docs/srs/appendix/D-traceability-matrix.md`
