...
| 正式交付产物 | 部分补齐 | SDK 0.4.4 / Contracts 0.4.3 PyPI 已完成；根应用源码已提升到 0.4.33，最新已记录 macOS 0.4.16 内部更新包已重新生成并上传；0.4.33 客户端包、Git tag / GitHub release、Windows 真机安装/升级证据和正式交付签收仍需补齐 |
