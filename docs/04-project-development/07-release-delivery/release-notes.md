...
| Root wheel/sdist build | 通过（2026-04-29 产物：`crawler4j-0.3.2`） |
...
- `0.3.2` 对应的 Git tag、正式 release notes 与交付批次仍未完成
...
- 按 [版本治理规则](version-governance.md) 复验 `0.3.2` 仍是目标正式版本，且 README / 包描述 / release 文档不再混用旧口径
