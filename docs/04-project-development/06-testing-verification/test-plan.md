...
| `TC-008` | 历史 `module_runtime.py` / `@env_selector(...)` 覆盖项已退出当前协议；当前以 `hooks/*.py`、`candidates/*.py`、`pages/*.py` 和 Core runtime descriptor 扫描回归为准 | `test_v2_scanner_diagnostics.py`、`test_mms.py`、`test_cli_scaffold.py`、`test_contracts_exports.py` |
